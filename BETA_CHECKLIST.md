...
- [ ] Criar Supabase isolado para automatizar E2E de Auth, RLS, Storage e duas contas. Tentativa em 21/08/2026: bloqueada pelo limite de 2 projetos free da conta — o segundo projeto existente (`cxinrqkfesnddqoswygk`, não usado por este app) estava em hibernação automática e não pôde ser pausado nem excluído nesse estado. Nenhum projeto novo foi criado, nada foi alterado na conta. Retomar quando o proprietário decidir: esperar a hibernação passar, autorizar exclusão do projeto extra, ou fazer upgrade de plano.
